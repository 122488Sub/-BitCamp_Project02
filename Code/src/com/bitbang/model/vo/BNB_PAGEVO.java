...
public class BNB_PAGEVO {
	...
	private int begin = 0; //현재 블록의 시작 페이지 번호
	private int end = 0; //현재 페이지상의 마지막 글 번호
	
	private int beginPage = 0; //현재 블록의 시작 페이지 번호
	private int endPage = 0; //현재 블록의 끝 페이지 번호
	
	//전체 페이지 갯수 구하기
	// totalRecord 값을 페이지당 표시할 글의 개수 값을 나누고, 나머지가 있으면 페이지 하나 더 추가
	...
	public String toString() {
		return "BNB_PAGEVO [nowPage=" + nowPage + ", nowBlock=" + nowBlock + ", numPerPage=" + numPerPage
