...
<body>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fee02fb4d84269b4fcd23a921885416f&libraries=services"></script> 
	<script> 
		//////////////////// // 카카오 지도 API S /////////////////// 
		...
		//지도를 담을 영역의 DOM 레퍼런스 
		var options = { center: new kakao.maps.LatLng(33.450701, 126.570667), // 위도경도 level: 3 //지도의 레벨(확대, 축소 정도) }; 
