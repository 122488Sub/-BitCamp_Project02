...
<div class="map_wrap">
	...
	<ul id="category2">
		<li id="CT1" data-order="0"><span class="category_bg bank"></span>
			문화시설</li>
		<li id="AT4" data-order="1"><span class="category_bg mart"></span>
			관광명소</li>
		<li id="AD5" data-order="2"><span class="category_bg pharmacy"></span>
			숙박</li>
...
<script>
	...
	<%System.out.println(request.getParameter("safe"));%>
	geocoder.addressSearch('<%=request.getParameter("safe")%>', function(result, status) {
	    // 정상적으로 검색이 완료됐으면 
	  ...
	  // 엘리먼트에 이벤트 핸들러를 등록하는 함수입니다
	 	...
	 	function addCategoryClickEvent() {
	 		var category2 = document.getElementById('category2'), children = category2.children;
	 	...
	 	function changeCategoryClass(el) {
	 		var category = document.getElementById('category2'), children = category.children, i;
